...
DOMAIN_EMBED_DIM = 10
AUTHOR_EMBED_DIM = 10
TITLE_EMBED_DIM = 300  # Assuming the embedding dimension of the title is 300
HIDDEN_DIM = 128
BATCH_SIZE = 2048
EPOCHS = 10
LR = 1e-3
...
TITLE_EMBED_FILE = "weights/word2vec_cbow_text8-hn_vibrant-water-53.pt"
TITLE_VOCAB_FILE = "weights/word2vec_cbow_text8-hn_vibrant-water-53_vocab.json"

# Load title embeddings and vocab
with open(TITLE_VOCAB_FILE, "r") as f:
...
class HNRegressionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        features = {
            ...
            "title_embedding": self.title_embeddings[idx],
        }
...
class FeatureFusionRegressionModel(nn.Module):
    def __init__(
        ...
        title_embed_dim=TITLE_EMBED_DIM,
        ...
        total_dim = domain_embed_dim + author_embed_dim + title_embed_dim
    ...
    def forward(self, features):
        ...
        title_emb = features["title_embedding"]
        x = torch.cat([domain_emb, author_emb, title_emb], dim=1)
        out = self.mlp(x)
